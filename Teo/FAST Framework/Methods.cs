...
namespace FAST_Framework
{
    ...
    public static class Methods
    {
        ...
        public static void OpenMobileClient()
        {
            ...
            login.SendKeys(Config.Credentials.Valid.Username);
            pass.SendKeys(Config.Credentials.Valid.Password);
        ...
        public static void SwitchToMobileClient()
        {
        ...
        public static void EnterTextValue(string text, bool sendEnter, string texboxId = "txtPromptText")
        {
            ...
            var next = driver.FindElementByAccessibilityId("imgNext");
        ...
        public static void ClickListItemByName(string name)
        {
            ...
            {
                Console.WriteLine("Failed to search element by name " + name);
            }
            //ListItem.Click();
            return;
        ...
        //public static WindowsElement WaitForElement(string by, int timeout, int msToRepeatCheck = 1000)
        //{
        //    try
        //    {
        //        var labels = driver.FindElementsByAccessibilityId("lblTransitionLabel");
